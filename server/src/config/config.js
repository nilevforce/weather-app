...
if (!OPENWEATHER_API_KEY) throw new Error('The OPENWEATHER_API_KEY environment variable is not defined.');
if (!WEATHERAPI_API_KEY) throw new Error('The WEATHERAPI_API_KEY environment variable is not defined.');
